...
class NativeCanvasView(context: Context) : GLSurfaceView(context) {
    ...
    var color = 0xFF111111.toInt()
        set(value){field=value;if(nativeHandle!=0L)syncColor()}
    ...
    private fun syncColor(){val c=color;nativeSetColor(nativeHandle,((c shr 16) and 255)/255f,((c shr 8) and 255)/255f,(c and 255)/255f)}
